...
NODE_OUT_DEGREE_FILE = os.path.join(PATH, 'out.dist')
NODE_IN_DEGREE_FILE = os.path.join(PATH, 'in.dist')
NODE_UG_DEGREE_FILE = os.path.join(PATH, 'ug.dist')
DEGREE_FILE = os.path.join(PATH, 'degree.txt')
